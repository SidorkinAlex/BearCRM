...
use SuiteCRM\MVC\Responds\RespondFactory;
...
class CustomBOARDController extends SugarController
{
    ...
    public function action_getCountOpp(){
        $seedOpp=new BOARD();
        RespondFactory::createRespond('html',$seedOpp->getCountOpp());
    }
    public function action_saveSattings(){
        ...
        RespondFactory::createRespond('redirect',"/index.php?module=BOARD&action=index&recipient_module={$_REQUEST['config_module_name']}");
    ...
    public function action_saveModuleSettings()
    {
        ...
        RespondFactory::createRespond('redirect',"/index.php?module=BOARD&action=moduleSettingsViews&message={$mod_strings['LBL_SAVE_SETTINGS']}");
    }
